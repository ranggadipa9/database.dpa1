...
<div id="content">
          <div class="box">
            ...
            <table id="tbl_sipeg" border="0" cellspacing="1" cellpadding="2" class="display">
                ...
                <?php foreach ($pemberian_air->result() as $peng): ?>
                    <tr>
                        ...
                        <td><?php
                            echo anchor('stb/ubahpemberian_air/' . $peng->id, 'Ubah') . " | " .
                            anchor('stb/hapuspemberian_air/' . $peng->id, 'Hapus', array('onClick' => "return confirm('Anda yakin pemberian_air .$peng->pemberian_air. akan dihapus? ')"));
                            ?>
                        </td>
                    </tr>
                    <?php $i++;
            ...
            <!--/div-->
            <br><br>
            <a href="<?php echo base_url() ?>stb/tambahpemberian_air/" id="submit" class="tambah">Tambah</a>
