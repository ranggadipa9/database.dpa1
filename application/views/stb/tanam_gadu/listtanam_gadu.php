...
<div id="content">
          <div class="box">
            ...
            <table id="tbl_sipeg" border="0" cellspacing="1" cellpadding="2" class="display">
                ...
                <?php foreach ($tanam_gadu->result() as $peng): ?>
                    <tr>
                      ...
                      <td><?php
                            echo anchor('stb/ubahtanam_gadu/' . $peng->id, 'Ubah') . " | " .
                            anchor('stb/hapustanam_gadu/' . $peng->id, 'Hapus', array('onClick' => "return confirm('Anda yakin Data .$peng->nama_areal. akan dihapus? ')"));
                            ?>
                        </td>
                    </tr>
                    <?php $i++;
            ...
            <!--/div-->
            <br><br>
            <a href="<?php echo base_url() ?>stb/tambahtanam_gadu/" id="submit" class="tambah">Tambah</a>
