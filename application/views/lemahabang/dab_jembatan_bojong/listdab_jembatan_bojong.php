...
<div id="content">
          <div class="box">
            ...
            <table id="tbl_sipeg" border="0" cellspacing="1" cellpadding="2" class="display">
                ...
                <?php foreach ($dab_jembatan_bojong->result() as $peng): ?>
                    <tr>
                        ...
                        <td><?php
                            echo anchor('lemahabang/ubahdab_jembatan_bojong/' . $peng->id, 'Ubah') . " | " .
                            anchor('lemahabang/hapusdab_jembatan_bojong/' . $peng->id, 'Hapus', array('onClick' => "return confirm('Anda yakin TMA .$peng->tma. akan dihapus? ')"));
                            ?>
                        </td>
                    </tr>
                    <?php $i++;
            ...
            <!--/div-->
            <br><br>
            <a href="<?php echo base_url() ?>lemahabang/tambahdab_jembatan_bojong/" id="submit" class="tambah">Tambah</a>
