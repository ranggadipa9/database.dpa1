...
<div id="content">
          <div class="box">
            ...
            <table id="tbl_sipeg" border="0" cellspacing="1" cellpadding="2" class="display">
                ...
                <?php foreach ($invent_area->result() as $peng): ?>
                    <tr>
                        ...
                        <td><?php
                            echo anchor('lemahabang/ubahinvent_area/' . $peng->id, 'Ubah') . " | " .
                            anchor('lemahabang/hapusinvent_area/' . $peng->id, 'Hapus', array('onClick' => "return confirm('Anda yakin blok .$peng->blok. akan dihapus? ')"));
                            ?>
                        </td>
                    </tr>
                    <?php $i++;
            ...
            <!--/div-->
            <br><br>
            <a href="<?php echo base_url() ?>lemahabang/tambahinvent_area/" id="submit" class="tambah">Tambah</a>
<!-- end #content -->
</div>
        </div>
