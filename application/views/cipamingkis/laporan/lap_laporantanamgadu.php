<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#btn-cetak').click(function() {
            ...
            w = window.open(base_url + 'cetaklaporantanamgadu/' + saluran_tanam + '/' + seksi + '/' + tgl1 + '/' + tgl2);
        });
    });
</script>
<title>
...
<h2>Laporan Rekapitulasi Tanam Gadu</h2>
<br/>

Saluran Tanam :
<br/>
<select name="cmbsaluran_tanam" id="cmbsaluran_tanam">
