...
<title>
	...
	<div id="content">
          <div class="box">
            ...
            <table id="tbl_sipeg" border="0" cellspacing="1" cellpadding="2" class="display">
                ...
                <?php foreach ($curah_hujan->result() as $peng): ?>
                    <tr>
                        ...
                        <td width="10%"><?php
                            echo anchor('cipamingkis/ubahcurah_hujan/' . $peng->id, 'Ubah') . "  " .
                            anchor('cipamingkis/hapuscurah_hujan/' . $peng->id, 'Hapus', array('onClick' => "return confirm('Anda yakin nomor .$peng->nomor. akan dihapus? ')"));
                            ?>
                        </td>
                    </tr>
                    <?php $i++;
            ...
            <!--/div-->
            <br><br>
            <a href="<?php echo base_url() ?>cipamingkis/tambahcurah_hujan/" id="submit" class="tambah">Tambah</a>
