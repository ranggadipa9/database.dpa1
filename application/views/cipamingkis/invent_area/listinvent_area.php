...
<title>
	...
	<div id="content">
          <div class="box">
            <h2>Data Inventaris Areal Tanam</h2>
            <p>&nbsp;</p>
            <?php $i = 1; ?>
            <table id="tbl_sipeg" border="0" cellspacing="1" cellpadding="2" class="display">
                ...
                <?php foreach ($invent_area->result() as $peng): ?>
                    <tr>
                        ...
                        <td><?php
                            echo anchor('cipamingkis/ubahinvent_area/' . $peng->id, 'Ubah') . " | " .
                            anchor('cipamingkis/hapusinvent_area/' . $peng->id, 'Hapus', array('onClick' => "return confirm('Anda yakin blok .$peng->blok. akan dihapus? ')"));
                            ?>
                        </td>
                    </tr>
                    <?php $i++;
            ...
            <!--/div-->
            <br><br>
            <a href="<?php echo base_url() ?>cipamingkis/tambahinvent_area/" id="submit" class="tambah">Tambah</a>
