...
<title>
	...
	<div id="content">
          <div class="box">
            ...
            <table id="tbl_sipeg" border="0" cellspacing="1" cellpadding="2" class="display">
                ...
                <?php foreach ($pemakaian_air->result() as $peng): ?>
                    <tr>
                        ...
                        <td><?php
                            echo anchor('cipamingkis/ubahpemakaian_air/' . $peng->id, 'Ubah') . " | " .
                            anchor('cipamingkis/hapuspemakaian_air/' . $peng->id, 'Hapus', array('onClick' => "return confirm('Anda yakin blok .$peng->no_sppa. akan dihapus? ')"));
                            ?>
                        </td>
                    </tr>
                    <?php $i++;
            ...
            <!--/div-->
            <br><br>
            <a href="<?php echo base_url() ?>cipamingkis/tambahpemakaian_air/" id="submit" class="tambah">Tambah</a>
