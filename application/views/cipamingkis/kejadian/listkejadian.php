...
<title>
	...
	<div id="content">
          <div class="box">
            ...
            <table id="tbl_sipeg" border="0" cellspacing="1" cellpadding="2" class="display">
                ...
                <?php foreach ($kejadian->result() as $peng): ?>
                    <tr>
                        ...
                        <td width="10%"><?php
                            echo anchor('cipamingkis/ubahkejadian/' . $peng->id, 'Ubah') . "  " .
                            anchor('cipamingkis/hapuskejadian/' . $peng->id, 'Hapus', array('onClick' => "return confirm('Anda yakin nomor .$peng->kejadian. akan dihapus? ')"));
                            ?>
                        </td>
                    </tr>
                    <?php $i++;
            ...
            <!--/div-->
            <br><br>
            <a href="<?php echo base_url() ?>cipamingkis/tambahkejadian/" id="submit" class="tambah">Tambah</a>
