...
<title>
	...
	<div id="content">
          <div class="box">
            ...
            <table id="tbl_sipeg" border="0" cellspacing="1" cellpadding="2" class="display">
                ...
                <?php foreach ($dab_cipamingkis->result() as $peng): ?>
                    <tr>
                        ...
                        <td><?php
                            echo anchor('cipamingkis/ubahdab_cipamingkis/' . $peng->id, 'Ubah') . " | " .
                            anchor('cipamingkis/hapusdab_cipamingkis/' . $peng->id, 'Hapus', array('onClick' => "return confirm('Anda yakin Debet Air .$peng->q2. akan dihapus? ')"));
                            ?>
                        </td>
                    </tr>
                    <?php $i++;
            ...
            <!--/div-->
            <br><br>
            <a href="<?php echo base_url() ?>cipamingkis/tambahdab_cipamingkis/" id="submit" class="tambah">Tambah</a>
