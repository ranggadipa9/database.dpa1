...
<title>
	...
	<div id="content">
          <div class="box">
            ...
            <table id="tbl_sipeg" border="0" cellspacing="1" cellpadding="2" class="display">
                ...
                <?php foreach ($dab_cibeet->result() as $peng): ?>
                    <tr>
                        ...
                        <td><?php
                            echo anchor('admin/ubahdab_cibeet/' . $peng->id, 'Ubah') . "  " .
                            anchor('admin/hapusdab_cibeet/' . $peng->id, 'Hapus', array('onClick' => "return confirm('Anda yakin TMA .$peng->q2_kalicibeet. akan dihapus? ')"));
                            ?>
                        </td>
                    </tr>
                    <?php $i++;
            ...
            <!--/div-->
            <br><br>
            <a href="<?php echo base_url() ?>admin/tambahdab_cibeet/" id="submit" class="tambah">Tambah</a>
