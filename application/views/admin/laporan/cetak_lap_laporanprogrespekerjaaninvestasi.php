...
if ($mata_anggaran != 'Semua') {
    $sql .= " AND progres_pekerjaan_investasi.id_mata_anggaran = '$mata_anggaran' ";
...
$q = $q->result_array();
?>
<h3 align="center">REKAPITULASI DATA PROGRES PEKERJAAN INVESTASI</h3>
<p align="left">Tampilkan dalam File :  <a href="javascript:;" ><img src="../../../../spon/images/excel-icon.jpeg" alt="" width="25" height="25" onclick="window.open('../../../../excel/export_excel_progrespekerjaaninvestasi_edit.php','scrollwindow','top=200,left=300,width=800,height=500');" border="0" /></a></p>
<h3 align="center"><?php
