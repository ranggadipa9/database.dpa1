...
<p align="left">Tampilkan dalam File :  <a href="javascript:;" ><img src="../../../../spon/images/excel-icon.jpeg" alt="" width="25" height="25" onclick="window.open('../../../../excel/export_excel_dab_cikarang.php','scrollwindow','top=200,left=300,width=800,height=500');" border="0" /></a></p>
