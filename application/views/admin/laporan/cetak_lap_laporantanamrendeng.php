...
if ($saluran_tanam != 'Semua') {
    $sql .= "AND tanam_rendeng.id_saluran_tanam = '$saluran_tanam' ";
...
if ($seksi != 'Semua') {
    ...
    $sql .= $tmp . " tanam_rendeng.id_seksi = '$seksi'";
...
$q = $q->result_array();
?>
<h2 align="center">Laporan Data Tanam Rendeng</h2>
<p align="left">Tampilkan dalam File :  <a href="javascript:;" ><img src="../../../../../spon/images/excel-icon.jpeg" alt="" width="25" height="25" onclick="window.open('../../../../../excel/export_excel_tanamrendeng_edit.php','scrollwindow','top=200,left=300,width=800,height=500');" border="0" /></a></p>
