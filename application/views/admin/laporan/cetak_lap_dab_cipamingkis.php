...
//}
$sql .= "ORDER BY dab_cipamingkis.tanggal_input ";
$q = $this->db->query($sql);
$q = $q->result_array();
?>
<h3 align="center">REKAPITULASI DATA DEBET AIR BENDUNG CIPAMINGKIS</h3>
<h3 align="center">
</h2>
<p align="left">Tampilkan dalam File :  <a href="javascript:;" ><img src="../../../../spon/images/excel-icon.jpeg" alt="" width="25" height="25" onclick="window.open('../../../../excel/export_excel_dab_cipamingkis.php','scrollwindow','top=200,left=300,width=800,height=500');" border="0" /></a></p>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
      ...
      <td width="450" class="tutupkiri"><div align="center">Saluran Induk Kiri</div></td>
      <td width="450" class="tutupkiri"><div align="center">Saluran Induk Kanan</div></td>
    ...
    foreach ($q as $rs) {
        ...
        <tr >
            ...
            <td width="450" class="tutupkiri"><?php echo $rs['saluran_induk_kiri']; ?></td>
            <td width="450" class="tutupkiri"><?php echo $rs['saluran_induk_kanan']; ?></td>
            <td width="75" class="closeall"><?php echo $rs['q1']; ?></td>
