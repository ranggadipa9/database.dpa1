...
<title>
	...
	<div id="content">
      <div class="box">
        ...
        <p><br>
              <br>
              <a href="<?php echo base_url() ?>admin/tambahrealisasi_air/" id="submit" class="tambah">Tambah</a>
            <?php $i = 1; ?>
            <table id="tbl_sipeg" border="0" cellspacing="1" cellpadding="2" class="display">
                ...
                <?php foreach ($realisasi_air->result() as $peng): ?>
                    <tr>
                        <td><?php echo $i; ?></td>
                        ...
                        <td><?php
                            echo anchor('admin/ubahrealisasi_air/' . $peng->id, 'Ubah') . " | " .
                            anchor('admin/hapusrealisasi_air/' . $peng->id, 'Hapus', array('onClick' => "return confirm('Anda yakin Pelanggan .$peng->pelanggan. akan dihapus? ')"));
                            ?>
                        </td>
                    </tr>
                    <?php $i++;
