...
<title>
	...
	<div id="content">
          <div class="box">
            ...
            <table id="tbl_sipeg" border="0" cellspacing="1" cellpadding="2" class="display">
                ...
                <?php foreach ($tanam_rendeng->result() as $peng): ?>
                    <tr>
                      ...
                      <td><?php
                            echo anchor('admin/ubahtanam_rendeng/' . $peng->id, 'Ubah') . "  " .
                            anchor('admin/hapustanam_rendeng/' . $peng->id, 'Hapus', array('onClick' => "return confirm('Anda yakin Data .$peng->nama_areal. akan dihapus? ')"));
                            ?>
                      </td>
                    </tr>
                    <?php $i++;
            ...
            <!--/div-->
            <br><br>
            <a href="<?php echo base_url() ?>admin/tambahtanam_rendeng/" id="submit" class="tambah">Tambah</a>
