	...
	<div id="content">
          <div class="box">
            ...
            <table id="tbl_sipeg" border="0" cellspacing="1" cellpadding="2" class="display">
                ...
                <?php foreach ($progres_pekerjaan_investasi->result() as $gol): ?>
                    <tr>
                        <td><?php echo $i; ?></td>
                        ...
                        <td><?php
                            echo anchor('admin/ubahprogres_pekerjaan_investasi/' . $gol->id, 'Ubah') . "  " .
                            anchor('admin/hapusprogres_pekerjaan_investasi/' . $gol->id, 'Hapus', array('onClick' => "return confirm('Anda yakin Sub MA $gol->mata_anggaran akan dihapus? ')"));
                            ?>
                        </td>
                    </tr>
                    <?php $i++;
            ...
            <br><br>
            <a href="<?php echo base_url() ?>admin/tambahprogres_pekerjaan_investasi/" id="submit" class="tambah">Tambah</a>
