...
<title>
	...
	<div id="content">
          <div class="box">
            ...
            <table id="tbl_sipeg" border="0" cellspacing="1" cellpadding="2" class="display">
                ...
                <?php foreach ($dab_bekasi->result() as $peng): ?>
                    <tr>
                        ...
                        <td><?php
                            echo anchor('admin/ubahdab_bekasi/' . $peng->id, 'Ubah') . "  " .
                            anchor('admin/hapusdab_bekasi/' . $peng->id, 'Hapus', array('onClick' => "return confirm('Anda yakin TMA .$peng->tanggal_input. akan dihapus? ')"));
                            ?>
                        </td>
                    </tr>
                    <?php $i++;
            ...
            <!--/div-->
            <br><br>
            <a href="<?php echo base_url() ?>admin/tambahdab_bekasi/" id="submit" class="tambah">Tambah</a>
