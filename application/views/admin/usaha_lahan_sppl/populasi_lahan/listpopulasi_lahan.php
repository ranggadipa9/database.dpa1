...
<title>
	...
	<div id="content">
          <div class="box">
            ...
            <h2 align="center">Daftar Populasi Penggunaan Lahan di Divisi Pengelolaan Air I</h2>
            <p>&nbsp;</p>
            ...
            <table id="tbl_sipeg" border="0" cellspacing="1" cellpadding="2" class="display">
                ...
                <?php foreach ($populasi_lahan->result() as $peng): ?>
                    <tr>
                      ...
                      <td width="9%" rowspan="19" align="center"><?php echo $peng->alamat; ?></td>
