...
<title>
	...
	<div id="content">
          <div class="box">
            ...
            <table id="tbl_sipeg" border="0" cellspacing="1" cellpadding="2" class="display">
                ...
                <?php foreach ($dab_cikeas->result() as $peng): ?>
                    <tr>
                        ...
                        <td><?php
                            echo anchor('admin/ubahdab_cikeas/' . $peng->id, 'Ubah') . "  " .
                            anchor('admin/hapusdab_cikeas/' . $peng->id, 'Hapus', array('onClick' => "return confirm('Anda yakin Debet .$peng->jumlah. akan dihapus? ')"));
                            ?>
                        </td>
                    </tr>
                    <?php $i++;
            ...
            <!--/div-->
            <br><br>
            <a href="<?php echo base_url() ?>admin/tambahdab_cikeas/" id="submit" class="tambah">Tambah</a>
