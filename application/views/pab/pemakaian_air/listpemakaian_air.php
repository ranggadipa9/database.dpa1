...
<div id="content">
          <div class="box"><h2>Data Pemakaian Air Oleh Perusahan</h2>
            <p>&nbsp;</p>
            <?php $i = 1; ?>
            <table id="tbl_sipeg" border="0" cellspacing="1" cellpadding="2" class="display">
                ...
                <?php foreach ($pemakaian_air->result() as $peng): ?>
                    <tr>
                        ...
                        <td><?php
                            echo anchor('pab/ubahpemakaian_air/' . $peng->id, 'Ubah') . " | " .
                            anchor('pab/hapuspemakaian_air/' . $peng->id, 'Hapus', array('onClick' => "return confirm('Anda yakin blok .$peng->no_sppa. akan dihapus? ')"));
                            ?>
                        </td>
                    </tr>
                    <?php $i++;
            ...
            <!--/div-->
            <br><br>
            <a href="<?php echo base_url() ?>pab/tambahpemakaian_air/" id="submit" class="tambah">Tambah</a>
