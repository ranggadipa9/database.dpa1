...
<div id="content">
          <div class="box"><h2>Data Tanam Rendeng</h2>
            <p>&nbsp;</p>
            <?php $i = 1; ?>
            <table id="tbl_sipeg" border="0" cellspacing="1" cellpadding="2" class="display">
                ...
                <?php foreach ($tanam_rendeng->result() as $peng): ?>
                    <tr>
                      ...
                      <td><?php
                            echo anchor('pab/ubahtanam_rendeng/' . $peng->id, 'Ubah') . " | " .
                            anchor('pab/hapustanam_rendeng/' . $peng->id, 'Hapus', array('onClick' => "return confirm('Anda yakin Data .$peng->nama_areal. akan dihapus? ')"));
                            ?>
                      </td>
                    </tr>
                    <?php $i++;
            ...
            <!--/div-->
            <br><br>
            <a href="<?php echo base_url() ?>pab/tambahtanam_rendeng/" id="submit" class="tambah">Tambah</a>
