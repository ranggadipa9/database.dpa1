...
class Pab extends CI_Controller {
    ...
    function index() {
        ...
        $data['header'] = 'pab/header';
	$data['footer'] = 'pab/footer';
	$data['page'] = 'pab/page/home';
    ...
    function invent_area() {
        $data['title'] = 'pab:: Data Inventaris Area Lahan Tanam';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/invent_area/listinvent_area';
        $data['invent_area'] = $this->minvent_area->getinvent_area();
        $this->load->view('pab/template', $data);
    }

    function tambahinvent_area() {
        $this->load->model(array('minvent_area', 'mseksi','mpengamat','msaluran_sekunder'));
        $data['title'] = 'pab:: Tambah Data Inventaris Area Lahan Tanam';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/invent_area/addinvent_area';
        $this->load->view('pab/template', $data);
    }
	...
	$daerah_irigasi= $this->input->post('daerah_irigasi', TRUE);
        ...
        redirect('pab/invent_area');
    }

    function ubahinvent_area() {
        $id = $this->uri->segment(3);
        $this->load->model(array('minvent_area', 'mseksi','mpengamat','msaluran_sekunder'));
        $data['title'] = $this->uri->segment(4) . 'pab:: Ubah Data Inventaris Area Lahan Tanam';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['invent_area'] = $this->minvent_area->getinvent_areaid($id);
        $data['page'] = 'pab/invent_area/editinvent_area';
        $this->load->view('pab/template', $data);
    }
...
/* PEMAKAIAN AIR */
    ...
    function pemakaian_air() {
        $data['title'] = 'pab:: Data Pemakaian Air Kepada Pelanggan';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/pemakaian_air/listpemakaian_air';
    ...
    function tambahpemakaian_air() {
        ...
        $data['title'] = 'pab:: Tambah Data Pemakaian Air Oleh Perusahaan';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/pemakaian_air/addpemakaian_air';
        $this->load->view('pab/template', $data);
    }
	...
	$id_balai= $this->input->post('id_balai', TRUE);
        ...
        redirect('pab/pemakaian_air');
    }

    function ubahpemakaian_air() {
        $id = $this->uri->segment(3);
        $this->load->model(array('mpemakaian_air', 'mseksi','mpelanggan','mbalai'));
        $data['title'] = $this->uri->segment(4) . 'pab:: Ubah Data Pemakaian Air Oleh Pelanggan';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['pemakaian_air'] = $this->mpemakaian_air->getpemakaian_airid($id);
        $data['page'] = 'pab/pemakaian_air/editpemakaian_air';
        $this->load->view('pab/template', $data);
    }
...
/* PEMBERIAN AIR */
    ...
    function pemberian_air() {
        $data['title'] = 'pab:: Data Pemberian Air';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/pemberian_air/listpemberian_air';
    ...
    function tambahpemberian_air() {
        ...
        $data['title'] = 'pab:: Tambah Data Pemberian Air';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/pemberian_air/addpemberian_air';
        $this->load->view('pab/template', $data);
    }
	...
	$id_seksi= $this->input->post('id_seksi', TRUE);
        ...
        redirect('pab/pemberian_air');
    }

    function ubahpemberian_air() {
        $id = $this->uri->segment(3);
        $this->load->model(array('mpemberian_air', 'mseksi','msaluran_sekunder',''));
        $data['title'] = $this->uri->segment(4) . 'pab:: Ubah Data Pemberian Air';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['pemberian_air'] = $this->mpemberian_air->getpemberian_airid($id);
        $data['page'] = 'pab/pemberian_air/editpemberian_air';
        $this->load->view('pab/template', $data);
    }
    ...
    function kejadian() {
        ...
        $data['header'] = 'pab/header';
        $data['page'] = 'pab/kejadian/listkejadian';
        $data['footer'] = 'pab/footer';
    ...
    function tambahkejadian() {
        ...
        $data['header'] = 'pab/header';
        $data['page'] = 'pab/kejadian/addkejadian';
        $data['footer'] = 'pab/footer';
        $this->load->view('pab/template', $data);
    }
    ...
    function ubahkejadian() {
        ...
        $data['page'] = 'pab/kejadian/editkejadian';
        $data['footer'] = 'pab/footer';
        $this->load->view('pab/template', $data);
    }
...
/* CURAH HUJAN  */
    ...
    function curah_hujan() {
        $data['title'] = 'pab:: Data Curah Hujan';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/curah_hujan/listcurah_hujan';
    ...
    function tambahcurah_hujan() {
        ...
        $data['title'] = 'pab:: Tambah Data Curah Hujan';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/curah_hujan/addcurah_hujan';
        $this->load->view('pab/template', $data);
    }
    ...
    function ubahcurah_hujan() {
        ...
        $data['page'] = 'pab/curah_hujan/editcurah_hujan';
        $data['footer'] = 'pab/footer';
        $this->load->view('pab/template', $data);
    }
...
/* TANAM RENDENG  */
    ...
    function tanam_rendeng() {
        $data['title'] = 'pab:: Data Tanam Rendeng ';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/tanam_rendeng/listtanam_rendeng';
    ...
    function tambahtanam_rendeng() {
        ...
        $data['title'] = 'pab:: Tambah Data Tanam Rendeng';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/tanam_rendeng/addtanam_rendeng';
        $this->load->view('pab/template', $data);
    }
  ...
  //      $luar_target_jumlah= $this->input->post('luar_target_jumlah', TRUE);
        ...
        redirect('pab/tanam_rendeng');
    }

    function ubahtanam_rendeng() {
        $id = $this->uri->segment(3);
        $this->load->model(array('mtanam_rendeng', 'mseksi','msaluran_tanam','mgolongan_tanam'));
        $data['title'] = $this->uri->segment(4) . 'pab:: Ubah Data Tanam Rendeng';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['tanam_rendeng'] = $this->mtanam_rendeng->gettanam_rendengid($id);
        $data['page'] = 'pab/tanam_rendeng/edittanam_rendeng';
        $this->load->view('pab/template', $data);
    }
...
/* TANAM GADU  */
    ...
    function tanam_gadu() {
        $data['title'] = 'pab:: Data Tanam Gadu ';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/tanam_gadu/listtanam_gadu';
    ...
    function tambahtanam_gadu() {
        ...
        $data['title'] = 'pab:: Tambah Data Tanam Gadu';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/tanam_gadu/addtanam_gadu';
        $this->load->view('pab/template', $data);
    }
  ...
  //      $luar_target_jumlah= $this->input->post('luar_target_jumlah', TRUE);
        ...
        $this->mtanam_gadu->addtanam_gadu($tanggal_input, $daerah_irigasi, $id_seksi, $id_saluran_tanam, $kabupaten, $kecamatan, $nama_areal, 
                              ...
                              $target_puso, $luar_target_bibit, $luar_target_garap, $luar_target_tanam, $luar_target_panen,
                              $luar_target_jumlah, $luar_target_palawija, $keterangan);
        redirect('pab/tanam_gadu');
    }

    function ubahtanam_gadu() {
        $id = $this->uri->segment(3);
        $this->load->model(array('mtanam_gadu', 'mseksi','msaluran_tanam','mgolongan_tanam'));
        $data['title'] = $this->uri->segment(4) . 'pab:: Ubah Data Tanam Gadu';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['tanam_gadu'] = $this->mtanam_gadu->gettanam_gaduid($id);
        $data['page'] = 'pab/tanam_gadu/edittanam_gadu';
        $this->load->view('pab/template', $data);
    }
...
/* DAB CBL */
    ...
    function dab_cbl() {
        $data['title'] = 'pab:: Debet Air Bendung CBL';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/dab_cbl/listdab_cbl';
    ...
    function tambahdab_cbl() {
        ...
        $data['title'] = 'pab:: Tambah Data Debet Air Bendung CBL';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/dab_cbl/adddab_cbl';
        $this->load->view('pab/template', $data);
    }
    ...
    function simpandab_cbl() {
        ...
        $this->mdab_cbl->adddab_cbl($id_seksi, $tanggal_input, $jam, $limpasan, $debet_air, $disukatani_bsh1, $jumlah, 
                                    $keterangan);
        redirect('pab/dab_cbl');
    }

    function ubahdab_cbl() {
        $id = $this->uri->segment(3);
        $this->load->model(array('mdab_cbl', 'mseksi','',''));
        $data['title'] = $this->uri->segment(4) . 'pab:: Ubah Data Debet Air Bendung CBL';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['dab_cbl'] = $this->mdab_cbl->getdab_cblid($id);
        $data['page'] = 'pab/dab_cbl/editdab_cbl';
        $this->load->view('pab/template', $data);
    }
...
/* DAB CIKEAS */
    ...
    function dab_cikeas() {
        $data['title'] = 'pab:: Debet Air Bendung Cikeas';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/dab_cikeas/listdab_cikeas';
    ...
    function tambahdab_cikeas() {
        ...
        $data['title'] = 'pab:: Tambah Data Debet Air Bendung Cikeas';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/dab_cikeas/adddab_cikeas';
        $this->load->view('pab/template', $data);
    }
    ...
    function simpandab_cikeas() {
      ...
      //  $jumlah = $this->input->post('jumlah', TRUE);
        ...
        redirect('pab/dab_cikeas');
    }

    function ubahdab_cikeas() {
        $id = $this->uri->segment(3);
        $this->load->model(array('mdab_cikeas', 'mseksi','',''));
        $data['title'] = $this->uri->segment(4) . 'pab:: Ubah Data Debet Air Bendung Cikeas';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['dab_cikeas'] = $this->mdab_cikeas->getdab_cikeasid($id);
        $data['page'] = 'pab/dab_cikeas/editdab_cikeas';
        $this->load->view('pab/template', $data);
    }
    ...
    function dab_cipamingkis() {
        $data['title'] = 'pab:: Debet Air Bendung Cipamingkis';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/dab_cipamingkis/listdab_cipamingkis';
    ...
    function tambahdab_cipamingkis() {
        ...
        $data['title'] = 'pab:: Tambah Data Debet Air Bendung Cipamingkis';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/dab_cipamingkis/adddab_cipamingkis';
        $this->load->view('pab/template', $data);
    }
    ...
    function simpandab_cipamingkis() {
        ...
        $this->mdab_cipamingkis->adddab_cipamingkis($id_seksi, $tanggal_input, $jam, $limpasan, $saluran_induk_kiri, $saluran_induk_kanan, 
            $q1, $q2, $keterangan);
        redirect('pab/dab_cipamingkis');
    }

    function ubahdab_cipamingkis() {
        $id = $this->uri->segment(3);
        $this->load->model(array('mdab_cipamingkis', 'mseksi','',''));
        $data['title'] = $this->uri->segment(4) . 'pab:: Ubah Data Debet Air Bendung Cipamingkis';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['dab_cipamingkis'] = $this->mdab_cipamingkis->getdab_cipamingkisid($id);
        $data['page'] = 'pab/dab_cipamingkis/editdab_cipamingkis';
        $this->load->view('pab/template', $data);
    }
...
/* DAB JEMBATAN BOJONG */
    ...
    function dab_jembatan_bojong() {
        $data['title'] = 'pab:: Debet Air Jembatan Bojong';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/dab_jembatan_bojong/listdab_jembatan_bojong';
    ...
    function tambahdab_jembatan_bojong() {
        ...
        $data['title'] = 'pab:: Tambah Data Debet Air Jembatan Bojong';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/dab_jembatan_bojong/adddab_jembatan_bojong';
        $this->load->view('pab/template', $data);
    }
    ...
    function simpandab_jembatan_bojong() {
        ...
        redirect('pab/dab_jembatan_bojong');
    }

    function ubahdab_jembatan_bojong() {
        $id = $this->uri->segment(3);
        $this->load->model(array('mdab_jembatan_bojong', 'mseksi','',''));
        $data['title'] = $this->uri->segment(4) . 'pab:: Ubah Data Debet Air Jembatan Bojong';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['dab_jembatan_bojong'] = $this->mdab_jembatan_bojong->getdab_jembatan_bojongid($id);
        $data['page'] = 'pab/dab_jembatan_bojong/editdab_jembatan_bojong';
        $this->load->view('pab/template', $data);
    }
...
/* DAB LEMAHABANG*/
    ...
    function dab_lemahabang() {
        $data['title'] = 'pab:: Debet Air Bendung Lemahabang';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/dab_lemahabang/listdab_lemahabang';
    ...
    function tambahdab_lemahabang() {
        ...
        $data['title'] = 'pab:: Tambah Data Debet Air Bendung Lemahabang';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/dab_lemahabang/adddab_lemahabang';
        $this->load->view('pab/template', $data);
    }
    ...
    function simpandab_lemahabang() {
        ...
        redirect('pab/dab_lemahabang');
    }

    function ubahdab_lemahabang() {
        $id = $this->uri->segment(3);
        $this->load->model(array('mdab_lemahabang', 'mseksi','',''));
        $data['title'] = $this->uri->segment(4) . 'pab:: Ubah Data Debet Air Bendung Lemahabang';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['dab_lemahabang'] = $this->mdab_lemahabang->getdab_lemahabangid($id);
        $data['page'] = 'pab/dab_lemahabang/editdab_lemahabang';
        $this->load->view('pab/template', $data);
    }
...
/* DAB BENDUNG BEKASI */
    ...
    function dab_bekasi() {
        $data['title'] = 'pab:: Debet Air Bendung Bekasi';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/dab_bekasi/listdab_bekasi';
    ...
    function tambahdab_bekasi() {
        ...
        $data['title'] = 'pab:: Tambah Data Debet Air Bendung Bekasi';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/dab_bekasi/adddab_bekasi';
        $this->load->view('pab/template', $data);
    }
    ...
    function simpandab_bekasi() {
        ...
        redirect('pab/dab_bekasi');
    }

    function ubahdab_bekasi() {
        $id = $this->uri->segment(3);
        $this->load->model(array('mdab_bekasi', 'mseksi','',''));
        $data['title'] = $this->uri->segment(4) . 'pab:: Ubah Data Debet Air Bendung Bekasi';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['dab_bekasi'] = $this->mdab_bekasi->getdab_bekasiid($id);
        $data['page'] = 'pab/dab_bekasi/editdab_bekasi';
        $this->load->view('pab/template', $data);
    }
...
/* DAB BENDUNG CIBEET */
    ...
    function dab_cibeet() {
        $data['title'] = 'pab:: Debet Air Bendung Cibeet';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/dab_cibeet/listdab_cibeet';
    ...
    function tambahdab_cibeet() {
        ...
        $data['title'] = 'pab:: Tambah Data Debet Air Bendung Cibeet';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/dab_cibeet/adddab_cibeet';
        $this->load->view('pab/template', $data);
    }
    ...
    function simpandab_cibeet() {
        ...
        redirect('pab/dab_cibeet');
    }

    function ubahdab_cibeet() {
        $id = $this->uri->segment(3);
        $this->load->model(array('mdab_cibeet', 'mseksi','',''));
        $data['title'] = $this->uri->segment(4) . 'pab:: Ubah Data Debet Air Bendung Cibeet';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['dab_cibeet'] = $this->mdab_cibeet->getdab_cibeetid($id);
        $data['page'] = 'pab/dab_cibeet/editdab_cibeet';
        $this->load->view('pab/template', $data);
    }
...
/* DAB BENDUNG CIKARANG */
    ...
    function dab_cikarang() {
        $data['title'] = 'pab:: Debet Air Bendung Cikarang';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/dab_cikarang/listdab_cikarang';
    ...
    function tambahdab_cikarang() {
        ...
        $data['title'] = 'pab:: Tambah Data Debet Air Bendung Cikarang';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/dab_cikarang/adddab_cikarang';
        $this->load->view('pab/template', $data);
    }
    ...
    //    $pintu_penguras = $this->input->post('pintu_penguras', TRUE);
        ...
        redirect('pab/dab_cikarang');
    }

    function ubahdab_cikarang() {
        $id = $this->uri->segment(3);
        $this->load->model(array('mdab_cikarang', 'mseksi','',''));
        $data['title'] = $this->uri->segment(4) . 'pab:: Ubah Data Debet Air Bendung Cikarang';
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['dab_cikarang'] = $this->mdab_cikarang->getdab_cikarangid($id);
        $data['page'] = 'pab/dab_cikarang/editdab_cikarang';
        $this->load->view('pab/template', $data);
    }
...
/* LAPORAN */
    ...
    function laporancurahhujan() {
        ...
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/laporan/lap_curahhujan';
        $this->load->view('pab/template', $data);
    }
    ...
    function cetaklaporancurahhujan($seksi = '', $tgl1 = '', $tgl2 = '') {
        ...
        $data['page'] = $this->load->view('pab/laporan/cetak_lap_curahhujan', $data);
        $this->load->view('pab/laporan/template', $data);
    }
    ...
    function laporankejadian() {
        ...
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/laporan/lap_kejadian';
        $this->load->view('pab/template', $data);
    }
    ...
    function cetaklaporankejadian($seksi = '', $tgl1 = '', $tgl2 = '') {
        ...
        $data['tgl1'] = date('Y-m-d', strtotime($tgl1));
        $data['tgl2'] = date('Y-m-d', strtotime($tgl2));
        $data['page'] = $this->load->view('pab/laporan/cetak_lap_kejadian', $data);
        $this->load->view('pab/laporan/template', $data);
    }
    ...
    function laporanprogrespekerjaan() {
        ...
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/laporan/lap_laporanprogrespekerjaan';
        $this->load->view('pab/template', $data);
    }
    ...
    function cetaklaporanprogrespekerjaan( $tgl1 = '', $tgl2 = '') {
      ...
      //  $data['seksi'] = $seksi;
        $data['tgl1'] = date('Y-m-d', strtotime($tgl1));
        $data['tgl2'] = date('Y-m-d', strtotime($tgl2));
        $data['page'] = $this->load->view('pab/laporan/cetak_lap_laporanprogrespekerjaan', $data);
        $this->load->view('pab/laporan/template', $data);
    }   
    ...
    function laporanpemakaianair() {
        ...
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/laporan/lap_laporanpemakaianair';
        $this->load->view('pab/template', $data);
    }
    function cetaklaporanpemakaianair($balai = '', $seksi='',$tgl1 = '', $tgl2 = '') {
        ...
        $data['tgl1'] = date('Y-m-d', strtotime($tgl1));
        $data['tgl2'] = date('Y-m-d', strtotime($tgl2));
        $data['page'] = $this->load->view('pab/laporan/cetak_lap_laporanpemakaianair', $data);
        $this->load->view('pab/laporan/template', $data);
    }
    ...
    function laporanpemberianair() {
        ...
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/laporan/lap_laporanpemberianair';
        $this->load->view('pab/template', $data);
    }
    function cetaklaporanpemberianair($saluran_sekunder = '', $seksi='',$tgl1 = '', $tgl2 = '') {
        ...
        $data['tgl1'] = date('Y-m-d', strtotime($tgl1));
        $data['tgl2'] = date('Y-m-d', strtotime($tgl2));
        $data['page'] = $this->load->view('pab/laporan/cetak_lap_laporanpemberianair', $data);
        $this->load->view('pab/laporan/template', $data);
    }
    ...
    function laporaninventarea() {
        ...
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/laporan/lap_laporaninventarea';
        $this->load->view('pab/template', $data);
    }
    function cetaklaporaninventarea($saluran_sekunder = '', $seksi='',$tgl1 = '', $tgl2 = '') {
        ...
        $data['tgl1'] = date('Y-m-d', strtotime($tgl1));
        $data['tgl2'] = date('Y-m-d', strtotime($tgl2));
        $data['page'] = $this->load->view('pab/laporan/cetak_lap_laporaninventarea', $data);
        $this->load->view('pab/laporan/template', $data);
    }    
    ...
    function laporantanamrendeng() {
        ...
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/laporan/lap_laporantanamrendeng';
        $this->load->view('pab/template', $data);
    }
	...
	function cetaklaporantanamrendeng($saluran_tanam = '', $seksi='',$tgl1 = '', $tgl2 = '') {
        ...
        $data['tgl1'] = date('Y-m-d', strtotime($tgl1));
        $data['tgl2'] = date('Y-m-d', strtotime($tgl2));
        $data['page'] = $this->load->view('pab/laporan/cetak_lap_laporantanamrendeng', $data);
        $this->load->view('pab/laporan/template', $data);
    }    
    ...
    function laporantanamgadu() {
        ...
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/laporan/lap_laporantanamgadu';
        $this->load->view('pab/template', $data);
    }
	...
	function cetaklaporantanamgadu($saluran_tanam = '', $seksi='',$tgl1 = '', $tgl2 = '') {
        ...
        $data['tgl1'] = date('Y-m-d', strtotime($tgl1));
        $data['tgl2'] = date('Y-m-d', strtotime($tgl2));
        $data['page'] = $this->load->view('pab/laporan/cetak_lap_laporantanamgadu', $data);
        $this->load->view('pab/laporan/template', $data);
    }    
    ...
    function laporandebetair() {
        ...
        $data['header'] = 'pab/header';
        $data['footer'] = 'pab/footer';
        $data['page'] = 'pab/laporan/lap_laporandebetair';
        $this->load->view('pab/template', $data);
    }
	...
	function cetaklaporandebetair($bendung = '', $seksi='',$tgl1 = '', $tgl2 = '') {
        ...
        $data['tgl1'] = date('Y-m-d', strtotime($tgl1));
        $data['tgl2'] = date('Y-m-d', strtotime($tgl2));
        $data['page'] = $this->load->view('pab/laporan/cetak_lap_laporandebetair', $data);
        $this->load->view('pab/laporan/template', $data);
    } 
