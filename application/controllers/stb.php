...
class Stb extends CI_Controller {
    ...
    function index() {
        $data['title'] = 'STB:: Aplikasi DPA I PJTII';
        $data['header'] = 'stb/header';
	$data['footer'] = 'stb/footer';
	$data['page'] = 'stb/page/home';
    ...
    function invent_area() {
        $data['title'] = 'stb:: Data Inventaris Area Lahan Tanam';
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/invent_area/listinvent_area';
        $data['invent_area'] = $this->minvent_area->getinvent_area();
        $this->load->view('stb/template', $data);
    }

    function tambahinvent_area() {
        $this->load->model(array('minvent_area', 'mseksi','mpengamat','msaluran_sekunder'));
        $data['title'] = 'stb:: Tambah Data Inventaris Area Lahan Tanam';
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/invent_area/addinvent_area';
        $this->load->view('stb/template', $data);
    }
	...
	$daerah_irigasi= $this->input->post('daerah_irigasi', TRUE);
        ...
        redirect('stb/invent_area');
    }

    function ubahinvent_area() {
        $id = $this->uri->segment(3);
        $this->load->model(array('minvent_area', 'mseksi','mpengamat','msaluran_sekunder'));
        $data['title'] = $this->uri->segment(4) . 'stb:: Ubah Data Inventaris Area Lahan Tanam';
        $data['header'] = 'stb/header';
        $data['invent_area'] = $this->minvent_area->getinvent_areaid($id);
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/invent_area/editinvent_area';
        $this->load->view('stb/template', $data);
    }
...
/* PEMAKAIAN AIR */
    ...
    function pemakaian_air() {
        $data['title'] = 'stb:: Data Pemakaian Air Kepada Pelanggan';
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/pemakaian_air/listpemakaian_air';
    ...
    function tambahpemakaian_air() {
        ...
        $data['title'] = 'stb:: Tambah Data Pemakaian Air Oleh Perusahaan';
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/pemakaian_air/addpemakaian_air';
        $this->load->view('stb/template', $data);
    }
	...
	$id_balai= $this->input->post('id_balai', TRUE);
        ...
        redirect('stb/pemakaian_air');
    }

    function ubahpemakaian_air() {
        $id = $this->uri->segment(3);
        $this->load->model(array('mpemakaian_air', 'mseksi','mpelanggan','mbalai'));
        $data['title'] = $this->uri->segment(4) . 'stb:: Ubah Data Pemakaian Air Oleh Pelanggan';
        $data['header'] = 'stb/header';
        $data['pemakaian_air'] = $this->mpemakaian_air->getpemakaian_airid($id);
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/pemakaian_air/editpemakaian_air';
        $this->load->view('stb/template', $data);
    }
...
/* PEMBERIAN AIR */
    ...
    function pemberian_air() {
        $data['title'] = 'stb:: Data Pemberian Air';
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/pemberian_air/listpemberian_air';
    ...
    function tambahpemberian_air() {
        ...
        $data['title'] = 'stb:: Tambah Data Pemberian Air';
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/pemberian_air/addpemberian_air';
        $this->load->view('stb/template', $data);
    }
	...
	$id_seksi= $this->input->post('id_seksi', TRUE);
        ...
        redirect('stb/pemberian_air');
    }

    function ubahpemberian_air() {
        $id = $this->uri->segment(3);
        $this->load->model(array('mpemberian_air', 'mseksi','msaluran_sekunder',''));
        $data['title'] = $this->uri->segment(4) . 'stb:: Ubah Data Pemberian Air';
        $data['header'] = 'stb/header';
        $data['pemberian_air'] = $this->mpemberian_air->getpemberian_airid($id);
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/pemberian_air/editpemberian_air';
        $this->load->view('stb/template', $data);
    }
...
/* KEJADIAN  */
    ...
    function kejadian() {
        ...
        $data['header'] = 'stb/header';
        $data['page'] = 'stb/kejadian/listkejadian';
        $data['footer'] = 'stb/footer';
    ...
    function tambahkejadian() {
        ...
        $data['header'] = 'stb/header';
        $data['page'] = 'stb/kejadian/addkejadian';
        $data['footer'] = 'stb/footer';
        $this->load->view('stb/template', $data);
    }
    ...
    function ubahkejadian() {
        ...
        $data['page'] = 'stb/kejadian/editkejadian';
        $data['footer'] = 'stb/footer';
        $this->load->view('stb/template', $data);
    }
...
/* CURAH HUJAN  */
    ...
    function curah_hujan() {
        $data['title'] = 'stb:: Data Curah Hujan';
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/curah_hujan/listcurah_hujan';
    ...
    function tambahcurah_hujan() {
        ...
        $data['title'] = 'stb:: Tambah Data Curah Hujan';
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/curah_hujan/addcurah_hujan';
        $this->load->view('stb/template', $data);
    }
    ...
    function ubahcurah_hujan() {
        ...
        $data['page'] = 'stb/curah_hujan/editcurah_hujan';
        $data['footer'] = 'stb/footer';
        $this->load->view('stb/template', $data);
    }
...
/* TANAM RENDENG  */
    ...
    function tanam_rendeng() {
        $data['title'] = 'stb:: Data Tanam Rendeng ';
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/tanam_rendeng/listtanam_rendeng';
    ...
    function tambahtanam_rendeng() {
        ...
        $data['title'] = 'stb:: Tambah Data Tanam Rendeng';
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/tanam_rendeng/addtanam_rendeng';
        $this->load->view('stb/template', $data);
    }
  ...
  //      $luar_target_jumlah= $this->input->post('luar_target_jumlah', TRUE);
        ...
        redirect('stb/tanam_rendeng');
    }

    function ubahtanam_rendeng() {
        $id = $this->uri->segment(3);
        $this->load->model(array('mtanam_rendeng', 'mseksi','msaluran_tanam','mgolongan_tanam'));
        $data['title'] = $this->uri->segment(4) . 'stb:: Ubah Data Tanam Rendeng';
        $data['header'] = 'stb/header';
        $data['tanam_rendeng'] = $this->mtanam_rendeng->gettanam_rendengid($id);
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/tanam_rendeng/edittanam_rendeng';
        $this->load->view('stb/template', $data);
    }
...
/* TANAM GADU  */
    ...
    function tanam_gadu() {
        $data['title'] = 'stb:: Data Tanam Gadu ';
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/tanam_gadu/listtanam_gadu';
    ...
    function tambahtanam_gadu() {
        ...
        $data['title'] = 'stb:: Tambah Data Tanam Gadu';
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/tanam_gadu/addtanam_gadu';
        $this->load->view('stb/template', $data);
    }
  ...
  //      $luar_target_jumlah= $this->input->post('luar_target_jumlah', TRUE);
        ...
        $this->mtanam_gadu->addtanam_gadu($tanggal_input, $daerah_irigasi, $id_seksi, $id_saluran_tanam, $kabupaten, $kecamatan, $nama_areal, 
                              ...
                              $target_puso, $luar_target_bibit, $luar_target_garap, $luar_target_tanam, $luar_target_panen,
                              $luar_target_jumlah, $luar_target_palawija, $keterangan);
        redirect('stb/tanam_gadu');
    }

    function ubahtanam_gadu() {
        $id = $this->uri->segment(3);
        $this->load->model(array('mtanam_gadu', 'mseksi','msaluran_tanam','mgolongan_tanam'));
        $data['title'] = $this->uri->segment(4) . 'stb:: Ubah Data Tanam Gadu';
        $data['header'] = 'stb/header';
        $data['tanam_gadu'] = $this->mtanam_gadu->gettanam_gaduid($id);
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/tanam_gadu/edittanam_gadu';
        $this->load->view('stb/template', $data);
    }
...
/* DAB CBL */
    ...
    function dab_cbl() {
        $data['title'] = 'stb:: Debet Air Bendung CBL';
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/dab_cbl/listdab_cbl';
    ...
    function tambahdab_cbl() {
        ...
        $data['title'] = 'stb:: Tambah Data Debet Air Bendung CBL';
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/dab_cbl/adddab_cbl';
        $this->load->view('stb/template', $data);
    }
    ...
    function simpandab_cbl() {
        ...
        $this->mdab_cbl->adddab_cbl($id_seksi, $tanggal_input, $jam, $limpasan, $debet_air, $disukatani_bsh1, $jumlah, 
                                    $keterangan);
        redirect('stb/dab_cbl');
    }

    function ubahdab_cbl() {
        $id = $this->uri->segment(3);
        $this->load->model(array('mdab_cbl', 'mseksi','',''));
        $data['title'] = $this->uri->segment(4) . 'stb:: Ubah Data Debet Air Bendung CBL';
        $data['header'] = 'stb/header';
        $data['dab_cbl'] = $this->mdab_cbl->getdab_cblid($id);
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/dab_cbl/editdab_cbl';
        $this->load->view('stb/template', $data);
    }
...
/* DAB CIKEAS */
    ...
    function dab_cikeas() {
        $data['title'] = 'stb:: Debet Air Bendung Cikeas';
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/dab_cikeas/listdab_cikeas';
    ...
    function tambahdab_cikeas() {
        ...
        $data['title'] = 'stb:: Tambah Data Debet Air Bendung Cikeas';
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/dab_cikeas/adddab_cikeas';
        $this->load->view('stb/template', $data);
    }
    ...
    function simpandab_cikeas() {
      ...
      //  $jumlah = $this->input->post('jumlah', TRUE);
        ...
        redirect('stb/dab_cikeas');
    }

    function ubahdab_cikeas() {
        $id = $this->uri->segment(3);
        $this->load->model(array('mdab_cikeas', 'mseksi','',''));
        $data['title'] = $this->uri->segment(4) . 'stb:: Ubah Data Debet Air Bendung Cikeas';
        $data['header'] = 'stb/header';
        $data['dab_cikeas'] = $this->mdab_cikeas->getdab_cikeasid($id);
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/dab_cikeas/editdab_cikeas';
        $this->load->view('stb/template', $data);
    }
    ...
    function dab_cipamingkis() {
        $data['title'] = 'stb:: Debet Air Bendung Cipamingkis';
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/dab_cipamingkis/listdab_cipamingkis';
    ...
    function tambahdab_cipamingkis() {
        ...
        $data['title'] = 'stb:: Tambah Data Debet Air Bendung Cipamingkis';
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/dab_cipamingkis/adddab_cipamingkis';
        $this->load->view('stb/template', $data);
    }
    ...
    function simpandab_cipamingkis() {
        ...
        $this->mdab_cipamingkis->adddab_cipamingkis($id_seksi, $tanggal_input, $jam, $limpasan, $saluran_induk_kiri, $saluran_induk_kanan, 
            $q1, $q2, $keterangan);
        redirect('stb/dab_cipamingkis');
    }

    function ubahdab_cipamingkis() {
        $id = $this->uri->segment(3);
        $this->load->model(array('mdab_cipamingkis', 'mseksi','',''));
        $data['title'] = $this->uri->segment(4) . 'stb:: Ubah Data Debet Air Bendung Cipamingkis';
        $data['header'] = 'stb/header';
        $data['dab_cipamingkis'] = $this->mdab_cipamingkis->getdab_cipamingkisid($id);
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/dab_cipamingkis/editdab_cipamingkis';
        $this->load->view('stb/template', $data);
    }
...
/* DAB JEMBATAN BOJONG */
    ...
    function dab_jembatan_bojong() {
        $data['title'] = 'stb:: Debet Air Jembatan Bojong';
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/dab_jembatan_bojong/listdab_jembatan_bojong';
    ...
    function tambahdab_jembatan_bojong() {
        ...
        $data['title'] = 'stb:: Tambah Data Debet Air Jembatan Bojong';
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/dab_jembatan_bojong/adddab_jembatan_bojong';
        $this->load->view('stb/template', $data);
    }
    ...
    function simpandab_jembatan_bojong() {
        ...
        redirect('stb/dab_jembatan_bojong');
    }

    function ubahdab_jembatan_bojong() {
        $id = $this->uri->segment(3);
        $this->load->model(array('mdab_jembatan_bojong', 'mseksi','',''));
        $data['title'] = $this->uri->segment(4) . 'stb:: Ubah Data Debet Air Jembatan Bojong';
        $data['header'] = 'stb/header';
        $data['dab_jembatan_bojong'] = $this->mdab_jembatan_bojong->getdab_jembatan_bojongid($id);
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/dab_jembatan_bojong/editdab_jembatan_bojong';
        $this->load->view('stb/template', $data);
    }
...
/* DAB LEMAHABANG*/
    ...
    function dab_lemahabang() {
        $data['title'] = 'stb:: Debet Air Bendung Lemahabang';
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/dab_lemahabang/listdab_lemahabang';
    ...
    function tambahdab_lemahabang() {
        ...
        $data['title'] = 'stb:: Tambah Data Debet Air Bendung Lemahabang';
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/dab_lemahabang/adddab_lemahabang';
        $this->load->view('stb/template', $data);
    }
    ...
    function simpandab_lemahabang() {
        ...
        redirect('stb/dab_lemahabang');
    }

    function ubahdab_lemahabang() {
        $id = $this->uri->segment(3);
        $this->load->model(array('mdab_lemahabang', 'mseksi','',''));
        $data['title'] = $this->uri->segment(4) . 'stb:: Ubah Data Debet Air Bendung Lemahabang';
        $data['header'] = 'stb/header';
        $data['dab_lemahabang'] = $this->mdab_lemahabang->getdab_lemahabangid($id);
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/dab_lemahabang/editdab_lemahabang';
        $this->load->view('stb/template', $data);
    }
...
/* DAB BENDUNG BEKASI */
    ...
    function dab_bekasi() {
        $data['title'] = 'stb:: Debet Air Bendung Bekasi';
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/dab_bekasi/listdab_bekasi';
    ...
    function tambahdab_bekasi() {
        ...
        $data['title'] = 'stb:: Tambah Data Debet Air Bendung Bekasi';
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/dab_bekasi/adddab_bekasi';
        $this->load->view('stb/template', $data);
    }
    ...
    function simpandab_bekasi() {
       ...
       // $id_seksi = $this->input->post('id_seksi', TRUE);
        ...
        redirect('stb/dab_bekasi');
    }

    function ubahdab_bekasi() {
        $id = $this->uri->segment(3);
        $this->load->model(array('mdab_bekasi', 'mseksi','',''));
        $data['title'] = $this->uri->segment(4) . 'stb:: Ubah Data Debet Air Bendung Bekasi';
        $data['header'] = 'stb/header';
        $data['dab_bekasi'] = $this->mdab_bekasi->getdab_bekasiid($id);
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/dab_bekasi/editdab_bekasi';
        $this->load->view('stb/template', $data);
    }
...
/* DAB BENDUNG CIBEET */
    ...
    function dab_cibeet() {
        $data['title'] = 'stb:: Debet Air Bendung Cibeet';
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/dab_cibeet/listdab_cibeet';
    ...
    function tambahdab_cibeet() {
        ...
        $data['title'] = 'stb:: Tambah Data Debet Air Bendung Cibeet';
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/dab_cibeet/adddab_cibeet';
        $this->load->view('stb/template', $data);
    }
    ...
    function simpandab_cibeet() {
       ...
       // $id_seksi = $this->input->post('id_seksi', TRUE);
        ...
        redirect('stb/dab_cibeet');
    }

    function ubahdab_cibeet() {
        $id = $this->uri->segment(3);
        $this->load->model(array('mdab_cibeet', 'mseksi','',''));
        $data['title'] = $this->uri->segment(4) . 'stb:: Ubah Data Debet Air Bendung Cibeet';
        $data['header'] = 'stb/header';
        $data['dab_cibeet'] = $this->mdab_cibeet->getdab_cibeetid($id);
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/dab_cibeet/editdab_cibeet';
        $this->load->view('stb/template', $data);
    }
...
/* DAB BENDUNG CIKARANG */
    ...
    function dab_cikarang() {
        $data['title'] = 'stb:: Debet Air Bendung Cikarang';
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/dab_cikarang/listdab_cikarang';
    ...
    function tambahdab_cikarang() {
        ...
        $data['title'] = 'stb:: Tambah Data Debet Air Bendung Cikarang';
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/dab_cikarang/adddab_cikarang';
        $this->load->view('stb/template', $data);
    }
    ...
    //    $pintu_penguras = $this->input->post('pintu_penguras', TRUE);
        ...
        redirect('stb/dab_cikarang');
    }

    function ubahdab_cikarang() {
        $id = $this->uri->segment(3);
        $this->load->model(array('mdab_cikarang', 'mseksi','',''));
        $data['title'] = $this->uri->segment(4) . 'stb:: Ubah Data Debet Air Bendung Cikarang';
        $data['header'] = 'stb/header';
        $data['dab_cikarang'] = $this->mdab_cikarang->getdab_cikarangid($id);
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/dab_cikarang/editdab_cikarang';
        $this->load->view('stb/template', $data);
    }
...
/* LAPORAN */
    ...
    function laporancurahhujan() {
        ...
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/laporan/lap_curahhujan';
        $this->load->view('stb/template', $data);
    }
    ...
    function cetaklaporancurahhujan($seksi = '', $tgl1 = '', $tgl2 = '') {
        ...
        $data['page'] = $this->load->view('stb/laporan/cetak_lap_curahhujan', $data);
        $this->load->view('stb/laporan/template', $data);
    }
    ...
    function laporankejadian() {
        ...
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/laporan/lap_kejadian';
        $this->load->view('stb/template', $data);
    }
    ...
    function cetaklaporankejadian($seksi = '', $tgl1 = '', $tgl2 = '') {
        ...
        $data['tgl1'] = date('Y-m-d', strtotime($tgl1));
        $data['tgl2'] = date('Y-m-d', strtotime($tgl2));
        $data['page'] = $this->load->view('stb/laporan/cetak_lap_kejadian', $data);
        $this->load->view('stb/laporan/template', $data);
    }
    ...
    function laporanprogrespekerjaan() {
        ...
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/laporan/lap_laporanprogrespekerjaan';
        $this->load->view('stb/template', $data);
    }
    ...
    function cetaklaporanprogrespekerjaan( $tgl1 = '', $tgl2 = '') {
      ...
      //  $data['seksi'] = $seksi;
        $data['tgl1'] = date('Y-m-d', strtotime($tgl1));
        $data['tgl2'] = date('Y-m-d', strtotime($tgl2));
        $data['page'] = $this->load->view('stb/laporan/cetak_lap_laporanprogrespekerjaan', $data);
        $this->load->view('stb/laporan/template', $data);
    }   
    ...
    function laporanpemakaianair() {
        ...
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/laporan/lap_laporanpemakaianair';
        $this->load->view('stb/template', $data);
    }
    function cetaklaporanpemakaianair($balai = '', $seksi='',$tgl1 = '', $tgl2 = '') {
        ...
        $data['tgl1'] = date('Y-m-d', strtotime($tgl1));
        $data['tgl2'] = date('Y-m-d', strtotime($tgl2));
        $data['page'] = $this->load->view('stb/laporan/cetak_lap_laporanpemakaianair', $data);
        $this->load->view('stb/laporan/template', $data);
    }
    ...
    function laporanpemberianair() {
        ...
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/laporan/lap_laporanpemberianair';
        $this->load->view('stb/template', $data);
    }
    function cetaklaporanpemberianair($saluran_sekunder = '', $seksi='',$tgl1 = '', $tgl2 = '') {
        ...
        $data['tgl1'] = date('Y-m-d', strtotime($tgl1));
        $data['tgl2'] = date('Y-m-d', strtotime($tgl2));
        $data['page'] = $this->load->view('stb/laporan/cetak_lap_laporanpemberianair', $data);
        $this->load->view('stb/laporan/template', $data);
    }
    ...
    function laporaninventarea() {
        ...
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/laporan/lap_laporaninventarea';
        $this->load->view('stb/template', $data);
    }
    function cetaklaporaninventarea($saluran_sekunder = '', $seksi='',$tgl1 = '', $tgl2 = '') {
        ...
        $data['tgl1'] = date('Y-m-d', strtotime($tgl1));
        $data['tgl2'] = date('Y-m-d', strtotime($tgl2));
        $data['page'] = $this->load->view('stb/laporan/cetak_lap_laporaninventarea', $data);
        $this->load->view('stb/laporan/template', $data);
    }    
    ...
    function laporantanamrendeng() {
        ...
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/laporan/lap_laporantanamrendeng';
        $this->load->view('stb/template', $data);
    }
	...
	function cetaklaporantanamrendeng($saluran_tanam = '', $seksi='',$tgl1 = '', $tgl2 = '') {
        ...
        $data['tgl1'] = date('Y-m-d', strtotime($tgl1));
        $data['tgl2'] = date('Y-m-d', strtotime($tgl2));
        $data['page'] = $this->load->view('stb/laporan/cetak_lap_laporantanamrendeng', $data);
        $this->load->view('stb/laporan/template', $data);
    }    
    ...
    function laporantanamgadu() {
        ...
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/laporan/lap_laporantanamgadu';
        $this->load->view('stb/template', $data);
    }
	...
	function cetaklaporantanamgadu($saluran_tanam = '', $seksi='',$tgl1 = '', $tgl2 = '') {
        ...
        $data['tgl1'] = date('Y-m-d', strtotime($tgl1));
        $data['tgl2'] = date('Y-m-d', strtotime($tgl2));
        $data['page'] = $this->load->view('stb/laporan/cetak_lap_laporantanamgadu', $data);
        $this->load->view('stb/laporan/template', $data);
    }    
 ...
 /* LAPORAN DEBET AIR*/   
    ...
    function laporan_dab_cibeet() {
        $data['title'] = 'Laporan Debet Air Bendung STB';
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/laporan/lap_dab_cibeet';
        $this->load->view('bekasi/template', $data);
    }

    function cetaklaporan_dab_cibeet( $tgl1 = '', $tgl2 = '') {
        $data['title'] = 'Cetak Laporan Debet Air Bendung STB';
      //  $data['seksi'] = $seksi;
        $data['tgl1'] = date('Y-m-d', strtotime($tgl1));
        $data['tgl2'] = date('Y-m-d', strtotime($tgl2));
        $data['page'] = $this->load->view('stb/laporan/cetak_lap_dab_cibeet', $data);
        $this->load->view('stb/laporan/template', $data);
    }   
    ...
    function laporan_dab_cikarang() {
        ...
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/laporan/lap_dab_cikarang';
        $this->load->view('bekasi/template', $data);
    }
    ...
    function cetaklaporan_dab_cikarang( $tgl1 = '', $tgl2 = '') {
      ...
      //  $data['seksi'] = $seksi;
        $data['tgl1'] = date('Y-m-d', strtotime($tgl1));
        $data['tgl2'] = date('Y-m-d', strtotime($tgl2));
        $data['page'] = $this->load->view('stb/laporan/cetak_lap_dab_cikarang', $data);
        $this->load->view('stb/laporan/template', $data);
    }
    ...
    function laporan_dab_bekasi() {
        ...
        $data['header'] = 'stb/header';
        $data['footer'] = 'stb/footer';
        $data['page'] = 'stb/laporan/lap_dab_bekasi';
        $this->load->view('bekasi/template', $data);
    }
    ...
    function cetaklaporan_dab_bekasi( $tgl1 = '', $tgl2 = '') {
      ...
      //  $data['seksi'] = $seksi;
        $data['tgl1'] = date('Y-m-d', strtotime($tgl1));
        $data['tgl2'] = date('Y-m-d', strtotime($tgl2));
        $data['page'] = $this->load->view('stb/laporan/cetak_lap_dab_bekasi', $data);
        $this->load->view('stb/laporan/template', $data);
    }
