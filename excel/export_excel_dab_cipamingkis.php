...
$objPHPExcel->getActiveSheet()->setCellValue('A12', "No")
							  ...
							  ->setCellValue('E12', "Saluran Induk")
							  ->setCellValue('E13', "Kiri")
							  ->setCellValue('F13', "Kanan")
							  ->setCellValue('G12', "Q1")
							  ->setCellValue('H12', "Q2 ")
							  ->setCellValue('I12', "Keterangan");
...
// query database
$SQL = mysql_query("select * from dab_cipamingkis order by tanggal_input");
...
while($row = mysql_fetch_array($SQL, MYSQL_ASSOC)){
	...
	$row_array['saluran_induk_kiri'] = $row['saluran_induk_kiri'];
	$row_array['saluran_induk_kanan'] = $row['saluran_induk_kanan'];
	$row_array['q1'] = $row['q1'];
	$row_array['q2'] = $row['q2'];
...
$objPHPExcel->getActiveSheet()->getStyle('A13:I13')->applyFromArray(
 array(
 'font' => array(
 'bold' => true
 ),
...
$objPHPExcel->getActiveSheet()->setCellValue('D4', "BENDUNG CIPAMINGKIS");
...
$objPHPExcel->getActiveSheet()->setCellValue('H8', "Lampiran");
$objPHPExcel->getActiveSheet()->setCellValue('H9', "Formulir No.");

$objPHPExcel->getActiveSheet()->setCellValue('I8', " : 2");
$objPHPExcel->getActiveSheet()->setCellValue('I9', " : F-Pros.13-02");
...
header('Content-Disposition: attachment;filename="DAB_Cipamingkis"'.date("d-F-Y").'".xlsx"');
