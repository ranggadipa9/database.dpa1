...
$objPHPExcel->getActiveSheet()->setCellValue('A12', "No")
							  ...
							  ->setCellValue('D12', "Stasiun Hujan")
							  ->setCellValue('D13', "Nomor")
							  ->setCellValue('E13', "Stasiun Hujan")
							  ->setCellValue('F12', "Curah Hujan")
...
while($row = mysql_fetch_array($SQL, MYSQL_ASSOC)){
	...
	$row_array['nomor'] = $row['nomor'];
	$row_array['nama_stasiun'] = $row['nama_stasiun'];
	$row_array['curah_hujan'] = $row['curah_hujan'];
...
$objPHPExcel->getActiveSheet()->setCellValue('B3', "DATA CURAH HUJAN HARIAN");

$objPHPExcel->getActiveSheet()->mergeCells('B4:G4');
$objPHPExcel->getActiveSheet()->setCellValue('B4', "Tanggal : ....... s/d .........");
...
$objPHPExcel->getActiveSheet()->setCellValue('A9', "Divi Pengelolaan Air I");

$objPHPExcel->getActiveSheet()->setCellValue('F8', "Lampiran");
$objPHPExcel->getActiveSheet()->setCellValue('F9', "Formulir No.");

$objPHPExcel->getActiveSheet()->setCellValue('G8', " : 4");
$objPHPExcel->getActiveSheet()->setCellValue('G9', " : F-Pros.13-04");
...
header('Content-Disposition: attachment;filename="Curah_Hujan"'.date("d-F-Y").'".xlsx"');
