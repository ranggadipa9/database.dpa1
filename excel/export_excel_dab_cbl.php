...
$objPHPExcel->getActiveSheet()->setCellValue('A12', "No")
							  ...
							  ->setCellValue('F12', "Disukatani BSh1")
							  ->setCellValue('G12', "Jumlah")
							  ->setCellValue('H12', "Keterangan");
...
// query database
$SQL = mysql_query("select * from dab_cbl order by tanggal_input");
...
while($row = mysql_fetch_array($SQL, MYSQL_ASSOC)){
	...
	$row_array['debet_air'] = $row['debet_air'];
	$row_array['disukatani_bsh1'] = $row['disukatani_bsh1'];
...
// Set title row bold;
$objPHPExcel->getActiveSheet()->getStyle('A12:H12')->getFont()->setBold(true);
// Set fills
$objPHPExcel->getActiveSheet()->getStyle('A12:H12')->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID);
$objPHPExcel->getActiveSheet()->getStyle('A12:H12')->getFill()->getStartColor()->setARGB('FF808080');
...
$objPHPExcel->getActiveSheet()->setSharedStyle($sharedStyle1, "A12:H$nox");
 
// Set style for header row using alternative method
$objPHPExcel->getActiveSheet()->getStyle('A12:H12')->applyFromArray(
 array(
 'font' => array(
 'bold' => true
 ),
...
$objPHPExcel->getActiveSheet()->getStyle('A13:H13')->applyFromArray(
 array(
 'font' => array(
 'bold' => true
 ),
...
$objPHPExcel->getActiveSheet()->setCellValue('D4', "BEDNUNG CBL");
...
$objPHPExcel->getActiveSheet()->getStyle('D2:G5')->getFont()->setName('Arial');
$objPHPExcel->getActiveSheet()->getStyle('D2:G5')->getFont()->setSize(11);
$objPHPExcel->getActiveSheet()->getStyle('D2:G5')->getFont()->setBold(true);
$objPHPExcel->getActiveSheet()->getStyle('D3:G5')->getFont()->setSize(11);
...
$objPHPExcel->getActiveSheet()->setCellValue('A9', "Seksi : Bekasi");

$objPHPExcel->getActiveSheet()->setCellValue('G8', "Lampiran");
$objPHPExcel->getActiveSheet()->setCellValue('G9', "Formulir No.");

$objPHPExcel->getActiveSheet()->setCellValue('H8', " : 2");
$objPHPExcel->getActiveSheet()->setCellValue('H9', " : F-Pros.13-02");

$objPHPExcel->getActiveSheet()->getStyle('A7:G9')->getFont()->setName('Arial');
$objPHPExcel->getActiveSheet()->getStyle('A7:G9')->getFont()->setSize(9);
$objPHPExcel->getActiveSheet()->getStyle('A9')->getFont()->setBold(true);


// Judul Center
$objPHPExcel->getActiveSheet()->getStyle('A2:G6')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
 

// Redirect output to a client’s web browser (Excel2007)
header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
header('Content-Disposition: attachment;filename="DAB_CBL"'.date("d-F-Y").'".xlsx"');
