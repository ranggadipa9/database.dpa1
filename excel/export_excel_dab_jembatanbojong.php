...
// query database
$SQL = mysql_query("select * from dab_jembatan_bojong order by tanggal_input");
...
$objPHPExcel->getActiveSheet()->setCellValue('A4', "BENDUNG / JEMBATAN BOJONG");
...
header('Content-Disposition: attachment;filename="DAB_Jembatan_Bojong"'.date("d-F-Y").'".xlsx"');
