...
$objPHPExcel->getActiveSheet()->setCellValue('A12', "No")
							  ...
							  ->setCellValue('E12', "Bendung")
							  ->setCellValue('F12', "Regu")
							  ->setCellValue('G12', "Nama Operator")
							  ->setCellValue('H12', "Kejadian");
...
while($row = mysql_fetch_array($SQL, MYSQL_ASSOC)){
	...
	$row_array['bendung'] = $row['bendung'];
	$row_array['regu'] = $row['regu'];
	$row_array['nama_operator'] = $row['nama_operator'];
	$row_array['kejadian'] = $row['kejadian'];
...
$objPHPExcel->getActiveSheet()->setCellValue('C2', "REKAPITULASI LAPORAN KEJADIAN");

$objPHPExcel->getActiveSheet()->mergeCells('C3:G3');
$objPHPExcel->getActiveSheet()->setCellValue('C3', "BENDUNG ............. ");
...
$objPHPExcel->getActiveSheet()->setCellValue('H9', " : F-Pros.13-07");
...
header('Content-Disposition: attachment;filename="Laporan_kejadian"'.date("d-F-Y").'".xlsx"');
