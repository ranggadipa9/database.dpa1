...
$objPHPExcel->getActiveSheet()->setCellValue('D3', "KELOMPOK BEBAN O&P SUMBER DAN PRASARANA SDA");
...
header('Content-Disposition: attachment;filename="Progres_Pekerjaan"'.date("d-F-Y").'".xlsx"');
