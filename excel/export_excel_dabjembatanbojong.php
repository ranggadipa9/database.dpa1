...
$queabsdetail = "SELECT
    *
FROM
    dpa1.dab_jembatan_bojong order by tanggal_input asc";
...
header("Content-Disposition: attachment;filename=dab_jembatan_bojong.xls " );
header("Content-Transfer-Encoding: binary " );
xlsBOF();
xlsWriteLabel(0,3,"Data Debit Air Jembatan Bojong" );
