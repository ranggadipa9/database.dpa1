...
$objPHPExcel->getActiveSheet()->setCellValue('A12', "No")
							  ...
							  ->setCellValue('F12', "Q1 (Suplesi Ke Tarumbarat)")
							  ->setCellValue('G12', "Q2 (Kali Cibeet)")
...
// query database
$SQL = mysql_query("select * from dab_cibeet order by tanggal_input");
...
while($row = mysql_fetch_array($SQL, MYSQL_ASSOC)){
	...
	$row_array['q1_suplesi_ketarumbarat'] = $row['q1_suplesi_ketarumbarat'];
	$row_array['q2_kalicibeet'] = $row['q2_kalicibeet'];
...
$objPHPExcel->getActiveSheet()->setCellValue('C2', "REKAPITULASI");

$objPHPExcel->getActiveSheet()->mergeCells('C3:G3');
$objPHPExcel->getActiveSheet()->setCellValue('C3', "DEBIT RATA-RATA SUMBER SETEMPAT / SUNGAI");

$objPHPExcel->getActiveSheet()->mergeCells('C4:G4');
$objPHPExcel->getActiveSheet()->setCellValue('C4', "BENDUNG CIBEET");

$objPHPExcel->getActiveSheet()->mergeCells('C5:G5');
$objPHPExcel->getActiveSheet()->setCellValue('C5', "Tanggal : ....... s/d .........");
...
$objPHPExcel->getActiveSheet()->getStyle('C2:I5')->getFont()->setSize(11);
$objPHPExcel->getActiveSheet()->getStyle('C2:I5')->getFont()->setBold(true);
$objPHPExcel->getActiveSheet()->getStyle('C3:I5')->getFont()->setSize(11);
...
header('Content-Disposition: attachment;filename="DAB_Cibeet"'.date("d-F-Y").'".xlsx"');
