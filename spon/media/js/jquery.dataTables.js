	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sInfo": "Menampilkan _START_ s/d _END_ dari total _TOTAL_ data",
				"sInfoEmpty": "Menampilkan 0 s/d 0 dari total 0 data",
				"sInfoFiltered": "(Pencarian dari total _MAX_ data)",
				"sInfoPostFix": "",
				"sSearch": "Pencarian:",
				"sUrl": "",
				"oPaginate": {
                ...
                ($.inArray('asc', oCol.asSorting) == -1 && $.inArray('desc', oCol.asSorting) == -1) )
      {
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  sSearchStr.replace('_INPUT_', '<input type="text" class="searchTable"/>') :
			  sSearchStr==="" ? '<input type="text" class="searchTable" />' : sSearchStr+' <input class="searchTable" type="text" />';
			
			var nFilter = document.createElement( 'div' );
			nFilter.className = oSettings.oClasses.sFilter;
			nFilter.innerHTML = '<span>'+sSearchStr+'</span>';
